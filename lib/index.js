...
i18n.localize = function(app, options) {
    ...
    var o = util.merge({
        ...
        ns: util.parseName(app.filename),
    ...
    function _translate(key, count) {
        var model = this.model
          , pluralSuffix = count !== undefined && typeof count === 'number'? i18n.plurals.get(model.get('_session.i18n.locale'), count): ''
          , translation = o.backend.get(model, model.get('_session.i18n.locale'), model.get('_session.i18n.namespace'), key + pluralSuffix)

        return !!pluralSuffix || !!count? util.applyReplacement(translation, { count: count }): translation;
    }
    function _locale() {
        return this.model.get('_session.i18n.locale');
    }
    function _language() {
        return this.model.get('_session.i18n.language');
    }
    function _region() {
        return this.model.get('_session.i18n.region');
    }
    function _localizedPath(path) {
        return o.urlScheme == 'path' ? '/'+this.model.get('_session.i18n.locale')+'/'+path : path;
    }
    app.proto.t = app.proto.translate = _translate;
    app.proto.localizedPath = _localizedPath;
